...
struct CardFlip: View {
    ...
    @Binding var card: DeckViewState.QuestionCard
    private let animationDelay: CGFloat = 0.35
    let cardHeight: CGFloat
    let onResultChange: (DeckViewState.QuestionCard.Result) -> Void
        ...
        VStack {
            ...
            VStack {
                ...
                Picker(
                    ...
                    ForEach(
                        DeckViewState.QuestionCard.Result
...
struct CardFlip_Previews: PreviewProvider {
    ...
    static func createPreviewCard(flipped: Bool) -> DeckViewState.QuestionCard {
        return DeckViewState.QuestionCard(
            id: UUID(),
            flipped: flipped,
